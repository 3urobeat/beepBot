 ...
 * Author: 3urobeat
 *
 * Last Modified: 2024-01-05 23:06:39
...
module.exports.run = async (bot, message, args, lang, logger, guildsettings, fn) => { //eslint-disable-line
    ...
    if (args[0]) {
        ...
        let resetUser = fn.getuserfrommsg(message, args, 0, null, true);
        ...
        collector.on("collect", (msg) => {
            ...
            if (msg.content == "y") {
                ...
                bot.levelsdb.update({ $and: [{ userid: resetUser.id }, { guildid: message.guild.id }] }, { $set: { xp: 0, messages: 0 } }, {}, (err, numAffected) => {
        ...
        collector.on("collect", (msg) => {
            ...
            if (msg.content == "y") {
                ...
                bot.levelsdb.update({ guildid: msg.guild.id }, { $set: { xp: 0, messages: 0 } }, { multi: true }, (err, numAffected) => {
                    if (err) logger("error", "levelReset.js", `Error updating db of guild ${message.guild.id}. Error: ${err}`);
