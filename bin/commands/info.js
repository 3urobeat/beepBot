module.exports.run = async (bot, message, args) => {
    ...
    try {
        var usergame = usermentioninfo.presence.game.name
    } catch (err) {
        var usergame = "/"
    }

    if (tempc && tempf == "null") {
        var cputemp = "Temperature unavailable."   
    } else {
        var cputemp = tempc + " °C | " + tempf + " °F"
    }
